...
//        DataFetcher { environment ->
//            val last = environment.getArgument<Long?>("last")
//
...
//                age = resultSet.getString("age")?.toLongOrNull(),
//                parentId = resultSet.getString("parent_id"),
//                favoriteCartoonId = resultSet.getString("favorite_cartoon")?.toLongOrNull()
//            )
//        }
//    }
//
//    private fun fetchFieldsFromLastUsers(fields: Set<Field>, last: Long?): List<Person> {
//        val fieldsQuery = fields.map { it.name }.joinToString { ", " }
...
//                age = environment.getArgument<Long>("age"),
//                children = emptyList()
//            ).also {
//                people.add(it)
//            }
...
//                age = env.getArgument<Long>("age"),
//                parentId = parent.id,
//                favoriteCartoonId = env.getArgument<Long>("favoriteCartoonId")
//            )
//
//            parent.copy(
